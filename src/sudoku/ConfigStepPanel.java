...
public class ConfigStepPanel extends javax.swing.JPanel {
	private static String[] fishTypes = {
			java.util.ResourceBundle.getBundle("intl/ConfigStepPanel").getString("ConfigStepPanel.fishType.basic"),
			java.util.ResourceBundle.getBundle("intl/ConfigStepPanel").getString("ConfigStepPanel.fishType.franken"),
			java.util.ResourceBundle.getBundle("intl/ConfigStepPanel").getString("ConfigStepPanel.fishType.mutant") };
