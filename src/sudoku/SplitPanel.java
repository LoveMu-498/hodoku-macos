...
public class SplitPanel extends javax.swing.JPanel {
	...
	/** Applies the screen-only dark surface to the internal split pane as well. */
	public void applyAppearance() {
		if (!ApplicationAppearance.isDark()) {
			return;
		}
		SudokuAppearancePalette palette = SudokuAppearancePalette.forRendering(false);
		setBackground(palette.getWindowBackground());
		splitPane.setBackground(palette.getWindowBackground());
		splitPane.setForeground(palette.getPrimaryForeground());
