...
//        g2.drawLine(1, 0, 1, h);
//        g2.drawLine(1, 1, w, 1);
		g2.setColor(ApplicationAppearance.isDark() ? new Color(105, 110, 118) : Color.LIGHT_GRAY);
		g2.drawLine(w, 0, w, h);
		g2.drawLine(0, h, w, h);
		g2.setColor(ApplicationAppearance.isDark() ? new Color(65, 69, 75) : Color.DARK_GRAY);
		g2.drawLine(0, 0, w, 0);
		g2.drawLine(0, 0, 0, h);

		if (reset) {
			if (ApplicationAppearance.isDark()) {
				g2.setColor(SudokuAppearancePalette.forRendering(false).getPrimaryForeground());
			}
			g2.setFont(font);
	...
	private void setColor() {
		...
		} else if (ApplicationAppearance.isDark()) {
			back = SudokuAppearancePalette.forRendering(false).getSurfaceBackground();
		} else {
