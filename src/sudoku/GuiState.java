...
public class GuiState {
	...
	private List<List<DoodleStroke>> doodleRedoHistory;
	private List<List<UserChain>> userChainUndoHistory;
	private List<List<UserChain>> userChainRedoHistory;
	private List<SudokuSet> boxReasoningGroups;
	private List<List<SudokuSet>> boxReasoningUndoHistory;
	private List<List<SudokuSet>> boxReasoningRedoHistory;
	private List<SortedMap<Integer, Color>> coloringUndoCells;
	private List<SortedMap<Integer, Color>> coloringUndoCandidates;
	private List<SortedMap<Integer, Color>> coloringRedoCells;
	private List<SortedMap<Integer, Color>> coloringRedoCandidates;
	...
	public List<DoodleStroke> getDoodleStrokes() {
		return doodleStrokes;
	}

	public void setDoodleStrokes(List<DoodleStroke> doodleStrokes) {
		this.doodleStrokes = doodleStrokes;
	}
	...
	public void setUserChains(List<UserChain> userChains) {
		this.userChains = userChains;
	}

	public List<List<DoodleStroke>> getDoodleUndoHistory() { return doodleUndoHistory; }
	public void setDoodleUndoHistory(List<List<DoodleStroke>> value) { doodleUndoHistory = value; }
	public List<List<DoodleStroke>> getDoodleRedoHistory() { return doodleRedoHistory; }
	public void setDoodleRedoHistory(List<List<DoodleStroke>> value) { doodleRedoHistory = value; }
	public List<List<UserChain>> getUserChainUndoHistory() { return userChainUndoHistory; }
	public void setUserChainUndoHistory(List<List<UserChain>> value) { userChainUndoHistory = value; }
	public List<List<UserChain>> getUserChainRedoHistory() { return userChainRedoHistory; }
	public void setUserChainRedoHistory(List<List<UserChain>> value) { userChainRedoHistory = value; }
	public List<SudokuSet> getBoxReasoningGroups() { return boxReasoningGroups; }
	public void setBoxReasoningGroups(List<SudokuSet> value) { boxReasoningGroups = value; }
	public List<List<SudokuSet>> getBoxReasoningUndoHistory() { return boxReasoningUndoHistory; }
	public void setBoxReasoningUndoHistory(List<List<SudokuSet>> value) { boxReasoningUndoHistory = value; }
	public List<List<SudokuSet>> getBoxReasoningRedoHistory() { return boxReasoningRedoHistory; }
	public void setBoxReasoningRedoHistory(List<List<SudokuSet>> value) { boxReasoningRedoHistory = value; }
	public List<SortedMap<Integer, Color>> getColoringUndoCells() { return coloringUndoCells; }
	public void setColoringUndoCells(List<SortedMap<Integer, Color>> value) { coloringUndoCells = value; }
	public List<SortedMap<Integer, Color>> getColoringUndoCandidates() { return coloringUndoCandidates; }
	public void setColoringUndoCandidates(List<SortedMap<Integer, Color>> value) { coloringUndoCandidates = value; }
	public List<SortedMap<Integer, Color>> getColoringRedoCells() { return coloringRedoCells; }
	public void setColoringRedoCells(List<SortedMap<Integer, Color>> value) { coloringRedoCells = value; }
	public List<SortedMap<Integer, Color>> getColoringRedoCandidates() { return coloringRedoCandidates; }
	public void setColoringRedoCandidates(List<SortedMap<Integer, Color>> value) { coloringRedoCandidates = value; }
