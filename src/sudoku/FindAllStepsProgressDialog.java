...
public class FindAllStepsProgressDialog extends javax.swing.JDialog {
	...
	public FindAllStepsProgressDialog(java.awt.Frame parent, boolean modal, Sudoku2 sudoku) {
		this(parent, modal, sudoku, null);
	}

	public FindAllStepsProgressDialog(java.awt.Frame parent, boolean modal, Sudoku2 sudoku,
			TechniqueStepCatalog catalog) {
		super(parent, modal);
		...
		if (catalog == null) {
			...
			thread = new Thread(new Runnable() {
				@Override public void run() {
					steps.addAll(catalog.findAllRawSteps(sudoku,
							FindAllStepsProgressDialog.this));
					if (!Thread.currentThread().isInterrupted()) {
						updateProgress(java.util.ResourceBundle
								.getBundle("intl/FindAllStepsProgressDialog")
								.getString("FindAllStepsProgressDialog.progress_Score"), 27);
						solver.SudokuSolverFactory.getDefaultSolverInstance()
								.getProgressScore(sudoku, steps, FindAllStepsProgressDialog.this);
					}
