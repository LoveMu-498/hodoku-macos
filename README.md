# HoDoKu macOS 社区修改版（非官方）

本项目基于 Bernhard Hobiger 的 [HoDoKu](https://hodoku.sourceforge.net/en/index.php)
及 [PseudoFish/Hodoku](https://github.com/PseudoFish/Hodoku)，针对 macOS 维护中文界面、
